...
public class ProductServiceImpl implements ProductService{
    ...
    public ProductServiceImpl() {
        ...
        map.put(2L, new Product(1L, "Guitar", "The guitar sounds great and looks cool.", BigDecimal.valueOf(155.00), "guitar.jpg"));
        map.put(3L, new Product(1L, "Bass Guitar", "Every bands need a solid bass guitar.", BigDecimal.valueOf(200.00), "bass-guitar.jpg"));        
